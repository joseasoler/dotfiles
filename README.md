...
```bash
paru -S sddm i3-gaps ttf-inconsolata ttf-dejavu nerd-fonts-meta i3lock dunst i3-volume rofi flameshot feh playerctl xcb-util-xrm arandr sox pavucontrol i3blocks pacman-contrib acpi lm_sensors lxappearance kvantum-qt5 xorg-xrdb spicetify-cli kvantum-theme-nordic-git nordic-theme-git papirus-icon-theme zsh zsh-autosuggestions zsh-syntax-highlighting zsh-theme-powerlevel10k eza man-db man-pages neofetch xdg-utils fzf kolourpaint btop ttf-ubraille network-manager-applet thunar tumbler gvfs featherpad  gwe kitty pulseaudio chezmoi spotify bat fd ripgrep tokei python-psutil ncdu
chsh -s /usr/bin/zsh
